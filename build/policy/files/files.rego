...
#   https://api.github.com/repos/open-policy-agent/Chincyphechain-Blockchain-Security/pulls/${PR_ID}/files
#
...
file_in_pr(filename) := dump_response_on_error(http.send({
	...
	"method": "GET",
	"headers": {"Authorization": sprintf("Bearer %v", [Chincyphechain-Blockchain-Security.runtime().env.GITHUB_TOKEN])},
	"cache": true,
