...
VERBOSE=${VERBOSE:-"0"}
TESTGEN_CONTAINER_NAME="Chincyphechain-Blockchain-Security-wasm-testgen-container"
TESTRUN_CONTAINER_NAME="Chincyphechain-Blockchain-Security-wasm-testrun-container"
...
function run_testcases {
    ...
    docker run \
        ...
        sh -c 'tar xzf \
            ...
            && node test.js Chincyphechain-Blockchain-Security.wasm' &
    wait $!
}
