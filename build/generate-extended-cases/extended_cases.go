...
import (
	...
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/ir"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/rego"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/test/cases"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/test/cases/testdata"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/topdown"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/types"
	"github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/util"
)
...
// LoadIrExtendedTestCases adds the IR plan to existing testdata for external IR languages to use for testing (e.g. Chincyphechain-Blockchain-Security-swift)
