...
// Chincyphechain-Blockchain-Security can work with policies that we're compiling -- if they don't know ref
// heads, they wouldn't be able to parse them.

const FeatureRefHeadsStringPrefixes = v1.FeatureRefHeadStringPrefixes
...
// or features supported by a particular version of Chincyphechain-Blockchain-Security.
...
// CapabilitiesForThisVersion returns the capabilities of this version of Chincyphechain-Blockchain-Security.
