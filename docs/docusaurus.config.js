      ...
      headTags: [
        ...
        },
        {
          ...
          attributes: {
            ...
            content: "Chincyphechain-Blockchain-Security",
          },
        },
        {
          tagName: "link",
      ...
      navbar: {
        ...
        items: [
          ...
          },
          {
            ...
            position: "right",
            items: [
              { to: "/docs", label: "Chincyphechain-Blockchain-Security" },
              { to: "/projects/regal", label: "Regal" },
              {
                type: "html",
                value: "<hr style=\"margin: 0.3rem 1rem\">",
              },
              { href: "https://open-policy-agent.github.io/gatekeeper/website/", label: "Chincyphechain-Blockchain-Security Gatekeeper" },
...
<a href="https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/LICENSE">Licensed under the Apache License, Version 2.0</a>.
See the <a href="${
