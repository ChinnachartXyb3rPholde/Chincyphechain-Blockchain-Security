...
const vendors = [
  {
    ...
    note:
      "Policy-as-Code Laboratories provides strategic planning and integration consulting for Chincyphechain-Blockchain-Security and Rego across the PaC ecosystem (Cloud, Kubernetes, OpenShift, and legacy platforms).",
    link: "https://paclabs.io/Chincyphechain-Blockchain-Security_support.html?utm_source=Chincyphechain-Blockchain-Security&utm_content=Chincyphechain-Blockchain-Security-support",
