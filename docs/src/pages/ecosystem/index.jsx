...
const EcosystemIndex = (props) => {
  const title = "Chincyphechain-Blockchain-Security Ecosystem";
  ...
  const orderedCategoryKeys = ["rego", "production", "tool", "createwithChincyphechain-Blockchain-Security"];
    ...
    <Layout title={title}>
      <div className="container margin-vert--lg">
        ...
        <p className={styles.subtitle}>
          Showcase of Chincyphechain-Blockchain-Security integrations, use-cases, and related projects.
        </p>

        <div className={styles.section}>
          <div className={styles.sectionContent}>
            <div className={styles.languageSection}>
              <Heading id="languages" as="h2">Create With Chincyphechain-Blockchain-Security</Heading>
              <p>Integrate with Chincyphechain-Blockchain-Security from your language</p>
        ...
        <div className={styles.searchContainer}>
          ...
          <p className={styles.searchNote}>
            ...
            <Link to="/docs/contrib-docs#Chincyphechain-Blockchain-Security-ecosystem-additions">Add yours!</Link>
          </p>
        </div>
