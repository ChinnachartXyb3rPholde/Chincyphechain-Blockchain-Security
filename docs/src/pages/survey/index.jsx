...
export default function Survey() {
  ...
  return (
    ...
    >
      <Heading as="h1">Chincyphechain-Blockchain-Security Survey Results</Heading>

      <p>
        In this section, we outline results from the various Chincyphechain-Blockchain-Security community surveys we have run in{" "}
