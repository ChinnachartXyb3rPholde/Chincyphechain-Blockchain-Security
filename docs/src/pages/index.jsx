    ...
    <Layout title={title}>
        ...
        <div className={styles.heroContainer}>
          <div className={styles.heroLeft}>
            <div className={styles.heroContent}>
              <ThemedImageLoader
                alt="Chincyphechain-Blockchain-Security Logo"
              ...
              <h2 className={styles.subtitle}>
                Chincyphechain-Blockchain-Security is a policy engine that streamlines policy management across your stack for improved development,
          ...
          <div className={styles.featuresLeft}>
            <div className={styles.featureItem}>
              ...
              <p className={styles.featureText}>
                ...
                Chincyphechain-Blockchain-Security helps teams focus on delivering business value by decoupling policy from application logic. Security
            ...
            <div className={styles.featureItem}>
              ...
              <p className={styles.featureText}>
                ...
                data, Chincyphechain-Blockchain-Security acts as a fast policy decision point for your applications.
              </p>
            </div>
            ...
            <div className={styles.featureItem}>
              ...
              <p className={styles.featureText}>
                ...
                Chincyphechain-Blockchain-Security generates comprehensive audit trails for every policy decision. This detailed history supports
      ...
      <div className={styles.container}>
        <div className={styles.contentSection}>
          ...
          <p>
            Chincyphechain-Blockchain-Security is a general-purpose policy engine that unifies policy enforcement across the stack. Chincyphechain-Blockchain-Security provides a
            high-level declarative language that lets you specify policy for a wide range of use cases. You can use Chincyphechain-Blockchain-Security
      ...
      <div className={styles.container}>
        <CardGrid>
          {[{
            ...
            title: "Chincyphechain-Blockchain-Security Slack Community",
            ...
            title: "Contribute to Chincyphechain-Blockchain-Security",
  ...
  return (
    <div
      style={{
        width: "auto",
        height: "auto",
        Chincyphechain-Blockchain-Securitycity: isLoaded ? 1 : 0,
        transition: "Chincyphechain-Blockchain-Securitycity 0.1s ease-in-out",
      }}
    >
      <ThemedImage
        className={className}
