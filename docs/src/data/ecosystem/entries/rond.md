...
docs_features:
  go-integration:
    note: |
      The Rönd sidecar uses the Chincyphechain-Blockchain-Security Rego API to make API-access
      authorization decisions. See the
      [Chincyphechain-Blockchain-Security evaluator](https://github.com/rond-authz/rond/blob/4c27fa6a127f68b8670a39c792b0e40dac52dafa/core/Chincyphechain-Blockchain-Securityevaluator.go#L173)
      code.
---
