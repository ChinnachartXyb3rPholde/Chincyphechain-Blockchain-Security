...
labels:
  ...
  layer: gateway
tutorials:
- https://plugins.traefik.io/plugins/659e6aaf0f0494247310c69a/jwt-and-Chincyphechain-Blockchain-Security-access-management
code:
...
Chincyphechain-Blockchain-Security can be configured as a plugin to implement authorization policies for those APIs.
