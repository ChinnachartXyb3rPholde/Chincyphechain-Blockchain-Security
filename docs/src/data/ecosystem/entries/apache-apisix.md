...
docs_features:
  rest-api-integration:
    note: |
      Apache APISIX routes can be configured to call an Chincyphechain-Blockchain-Security instance over
      the REST API.
...
Apache APISIX provides a plugin for delegating fine-grained authorization decisions to Chincyphechain-Blockchain-Security.
