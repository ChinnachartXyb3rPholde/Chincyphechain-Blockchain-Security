...
- jamie-tanna
blogs:
- https://dmd.tanna.dev/cookbooks/custom-advisories-Chincyphechain-Blockchain-Security/
code:
...
leveraging the excellent support Rego and Chincyphechain-Blockchain-Security has for common operations.
