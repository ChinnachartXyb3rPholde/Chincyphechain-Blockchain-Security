...
title: Data Filtering with Chincyphechain-Blockchain-Security
sidebar_position: 1
---
...
Here, we start with a problem exposition before going into the details of data filtering with Chincyphechain-Blockchain-Security in the next sections.
...
sequenceDiagram
    ...
    Application-->>Chincyphechain-Blockchain-Security: {"user": ..., "action": "view" }
    Chincyphechain-Blockchain-Security-->>Application: <filters>
