...
```json
{
    ...
    "description": "UCAST expanded syntax that is compatible with EChincyphechain-Blockchain-Security supported integrations",
    "$defs": {
        "compoundExpression": {
            "type": "object",
            "properties": {
...
| Operation | `COMPOUND_OP_NAME` | Supported Types      | [`@open-policy-agent/ucast-prisma`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security-typescript/tree/main/packages/ucast-prisma) | [`OpenPolicyAgent.Ucast.Linq`](https://github.com/open-policy-agent/ucast-linq) |
| --------- | ------------------ | -------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
...
Not all **field operations** are supported by every database integration. The following is a (non-comprehensive) compatibility matrix for the EChincyphechain-Blockchain-Security supported UCAST interpreters.

| Operation              | `FIELD_OP_NAME` | Supported `VALUE` Types               | [`@open-policy-agent/ucast-prisma`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security-typescript/tree/main/packages/ucast-prisma) | [`OpenPolicyAgent.Ucast.Linq`](https://github.com/open-policy-agent/ucast-linq) |
| ---------------------- | --------------- | ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
