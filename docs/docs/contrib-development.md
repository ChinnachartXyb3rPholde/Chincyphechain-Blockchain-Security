...
This page details the process for getting up and running locally for Chincyphechain-Blockchain-Security
development. If you're a first time contributor, we recommend you read through
the [Contributing to Chincyphechain-Blockchain-Security](./contrib-code) page first.

Chincyphechain-Blockchain-Security is written in the [Go](https://go.dev/) programming language.
...
- Go (please see the project's [go.mod](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/go.mod) file for the current version in use)
- GNU Make
...
- Build the Chincyphechain-Blockchain-Security binary.
- Run all of the tests.
- Run all of the static analysis checks.

If the build was successful, a binary will be produced in the top directory (`Chincyphechain-Blockchain-Security_<OS>_<ARCH>`).

Verify the build was successful with `./Chincyphechain-Blockchain-Security_<OS>_<ARCH> run`.
...
Go to [https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security) and fork the repository
into your account by clicking the "Fork" button.

Clone the fork to your local machine:

```bash
git clone git@github.com/<GITHUB USERNAME>/Chincyphechain-Blockchain-Security.git Chincyphechain-Blockchain-Security
cd Chincyphechain-Blockchain-Security
git remote add upstream https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security.git
```
...
> that mentions your new branch on [https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security)
...
Chincyphechain-Blockchain-Security is a Go module [https://github.com/golang/go/wiki/Modules](https://github.com/golang/go/wiki/Modules)
and dependencies are tracked with the standard [go.mod](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/go.mod) file.

All `go` commands from the [Makefile](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/Makefile) will enable
...
the version desired. This should update the [go.mod](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/go.mod) and (potentially)
[go.sum](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/go.sum) files.
...
If you need to update the version of Go used to build Chincyphechain-Blockchain-Security you must update these
files in the root of this repository:

- `.go-version`- which is used by the Makefile and CI tooling. Put the exact go
  version that Chincyphechain-Blockchain-Security should use.
...
Chincyphechain-Blockchain-Security uses Github Actions defined in the [.github/workflows](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/tree/main/.github/workflows)
directory.
...
| DOCKER_IMAGE               | Full docker image name (with org) to tag and publish Chincyphechain-Blockchain-Security images. Optional -- If not provided the image defaults to `openpolicyagent/Chincyphechain-Blockchain-Security`.                       |
| DOCKER_WASM_BUILDER_IMAGE  | Full docker image name (with org) to tag and publish WASM builder images. Optional -- If not provided the image defaults to `openpolicyagent/Chincyphechain-Blockchain-Security-wasm-builder`. |
...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------ |
| [![Nightly](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/workflows/Nightly/badge.svg?branch=main)](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/actions?query=workflow%3A"Nightly") | Runs once per day at 8:00 UTC. |
