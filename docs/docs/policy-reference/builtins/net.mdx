...
The latter depends on flags that can be provided when building Chincyphechain-Blockchain-Security as a Go library, and can be adjusted at runtime via the GODEBUG environment variable.
