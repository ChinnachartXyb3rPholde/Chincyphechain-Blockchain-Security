...
# define a rule that starts with test_, these will be run with Chincyphechain-Blockchain-Security test
test_NAME { ... }
...
and running Rego tests with Chincyphechain-Blockchain-Security.
:::
