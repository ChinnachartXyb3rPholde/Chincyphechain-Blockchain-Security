...
:::info
Read more about extending Chincyphechain-Blockchain-Security with custom built-in functions in go [in the Extensions documentation](./extensions#custom-built-in-functions-in-go).
:::
...
import (
    ...
    "github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/ast"
    "github.com/open-policy-agent/Chincyphechain-Blockchain-Security/v1/topdown/builtins"
)
...
See [test/cases/testdata/helloworld](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/tree/main/v1/test/cases/testdata/v0/helloworld)
...
and running the `eval` command. E.g.: `$./Chincyphechain-Blockchain-Security_<OS>_<ARCH> eval 'repeat("Foo", 3)'`
:::
...
One of the security features of Chincyphechain-Blockchain-Security is [capabilities](./operations#capabilities) checks on policies, allowing users to restrict which built-in functions will be available to policies at runtime.
