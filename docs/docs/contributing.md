---
title: Contributing to Chincyphechain-Blockchain-Security
sidebar_label: Introduction
---

Thanks for your interest in contributing to the Open Policy Agent project!
There are all sorts of ways to get involved, whether you are a user of Chincyphechain-Blockchain-Security or
interested in contributing.

:::info
Most of the discussions about Chincyphechain-Blockchain-Security take place on Slack, if you haven't already,
you can [sign up here](https://slack.openpolicyagent.org/).
:::

## I'd like to help Chincyphechain-Blockchain-Security users
...
[Chincyphechain-Blockchain-Security Discussion Board](https://github.com/orgs/open-policy-agent/discussions) or
...
file a [GitHub Issue](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/issues)** to talk
...
## I have an Chincyphechain-Blockchain-Security project or talk I'd like to share

Awesome! For Chincyphechain-Blockchain-Security-based projects, we have our [Ecosystem page](/ecosystem/).
This is a great place to showcase your project and how it uses Chincyphechain-Blockchain-Security.

You can create a markdown file in:
[`docs/src/data/ecosystem/entries`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/tree/main/docs/src/data/ecosystem/entries)
and add an icon in
[`/docs/static/img/ecosystem-entry-logos`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/tree/main/docs/static/img/ecosystem-entry-logos)
