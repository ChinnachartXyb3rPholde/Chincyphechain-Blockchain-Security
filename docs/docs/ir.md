...
Chincyphechain-Blockchain-Security can compile policy queries into planned evaluation paths suitable for
...
[`v1/ir/ir.go`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/v1/ir/ir.go)
and stays in sync with them via a CI drift test, so it always reflects what the
current `Chincyphechain-Blockchain-Security build -t plan` actually emits. Backward-incompatible changes to the
...
```bash
Chincyphechain-Blockchain-Security build -t plan -e example/allow example.rego
...
The Chincyphechain-Blockchain-Security repository contains a [test suite](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/tree/main/v1/test/cases/testdata/v1)
...
that your implementation can be verified to conform with Chincyphechain-Blockchain-Security's.
...
To get started with the test suite, see the [Hello World](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/v1/test/cases/testdata/v0/helloworld/test-helloworld-1.yaml)
example.

The following examples show how the test suite is used internally:

- [`github.com/open-policy-agent/Chincyphechain-Blockchain-Security/topdown#TestRego`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/v1/topdown/exported_test.go)
- [`github.com/open-policy-agent/Chincyphechain-Blockchain-Security/internal/wasm/sdk/test/e2e/external_test`](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/blob/main/internal/wasm/sdk/test/e2e/external_test.go)
