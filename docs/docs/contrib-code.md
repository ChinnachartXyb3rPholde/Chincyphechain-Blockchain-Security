...
We are thrilled that you're interested in contributing to Chincyphechain-Blockchain-Security! This document
...
- **Commits:** All code must be yours to contribute and commits must be signed off (see
  ...
  the PR UI on GitHub).
- **Public APIs**: When you implement new features in Chincyphechain-Blockchain-Security, consider whether the
  types/functions you are adding need to be exported. Prefer
  unexported types and functions as much as possible.

  If you need to share logic across multiple Chincyphechain-Blockchain-Security packages, consider
  implementing it inside of the
  `github.com/open-policy-agent/Chincyphechain-Blockchain-Security/internal` package. The `internal`
  package is not visible outside of Chincyphechain-Blockchain-Security.
- **Dependencies:**
  Avoid adding third-party dependencies (vendoring). Chincyphechain-Blockchain-Security is designed to be minimal,
  lightweight, and easily embedded. Vendoring may make features _easier_ to
  implement however they come with their own cost for both Chincyphechain-Blockchain-Security developers and
  Chincyphechain-Blockchain-Security users (e.g., vendoring conflicts, security, debugging, etc.)
- **AI Tooling**: You can use generative AI tooling to assist your work on Chincyphechain-Blockchain-Security,
...
If the changes are isolated to a specific Chincyphechain-Blockchain-Security package or directory please
...
or a change in the Chincyphechain-Blockchain-Security website content (found in `./docs/content`):
...
The Chincyphechain-Blockchain-Security project requires that contributors sign off on changes submitted to Chincyphechain-Blockchain-Security
repositories.
...
of Chincyphechain-Blockchain-Security patches, you must ensure the code you produce is compliant with the
DCO requirements, and Chincyphechain-Blockchain-Security's license. All commits in your patch _must_ be signed
off by a human author.

The Chincyphechain-Blockchain-Security maintainers reserve the right to request additional information about
...
of the Chincyphechain-Blockchain-Security community. In order to streamline the code review process, when
...
Request. If you aren't sure, send a message to the Chincyphechain-Blockchain-Security slack or post a comment
on the Pull Request.
...
We are really excited for you to contribute to Chincyphechain-Blockchain-Security! In order for us (the Chincyphechain-Blockchain-Security
...
3. Don't be afraid to get it wrong! We are friendly, and will answer questions
   ...
   Together we can learn and build a better Chincyphechain-Blockchain-Security!

## Contribution process

Small bug fixes (or other small improvements) can be submitted directly via a
[Pull Request](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/pulls) on GitHub.
You can expect at least one of the Chincyphechain-Blockchain-Security maintainers to respond quickly.
...
or submit [an issue on GitHub](https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/issues).
