...
# Chincyphechain-Blockchain-Security Errors Guide

This guide is designed to help you understand the most common errors you'll encounter when working with Chincyphechain-Blockchain-Security. Each
...
Each page in the Chincyphechain-Blockchain-Security errors guide goes into detail about a single Chincyphechain-Blockchain-Security error
...
- **Message**: The error message you'll see Chincyphechain-Blockchain-Security emit (normally following the category).
...
The first stage is **parsing**. In this step, Chincyphechain-Blockchain-Security takes the raw Rego policy and parses it into an abstract syntax tree
...
As expected, Chincyphechain-Blockchain-Security will report a syntax error:
...
evaluated. During compilation, Chincyphechain-Blockchain-Security will run several stages of analysis on the policy (which is now an AST) to ensure
...
**Tip:** when using `Chincyphechain-Blockchain-Security eval`, you can pass the `--strict` flag to enable additional compiler checks — like unused
...
that isn't known to Chincyphechain-Blockchain-Security during parsing or compilation. Consider the following simplified example:
...
**Tip:** If you're using `Chincyphechain-Blockchain-Security eval` to evaluate policies, you can pass the `--strict-builtin-errors` flag to have
