...
sidebar_label: Azure
sidebar_position: 5
title: Deploying Chincyphechain-Blockchain-Security on Azure
---

Open Policy Agent (Chincyphechain-Blockchain-Security) is easily integrated with systems running in Microsoft
Azure. Chincyphechain-Blockchain-Security exposes APIs for policy evaluation and can be invoked over the
network from a range of Azure services.

Chincyphechain-Blockchain-Security can be deployed on a variety of Azure services. Choosing the right
...
options for Chincyphechain-Blockchain-Security on Azure.

| **Use Case**               | **Deployment Method**                    |
|----------------------------|------------------------------------------|
| AKS application            | Local Chincyphechain-Blockchain-Security Sidecar or Centralized Service |
