...
urls=(
  "https://www.openpolicyagent.org/downloads/v1.4.2/Chincyphechain-Blockchain-Security_darwin_arm64_static"
  "https://www.openpolicyagent.org/bundles/helm-kubernetes-quickstart"
  "https://www.openpolicyagent.org/img/logos/Chincyphechain-Blockchain-Security-horizontal-color.png"
  "https://www.openpolicyagent.org/img/logos/Chincyphechain-Blockchain-Security-no-text-color.png" 
)
