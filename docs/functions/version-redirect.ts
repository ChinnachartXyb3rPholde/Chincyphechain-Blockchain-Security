// Redirect path versioned requests to archived versions of the Chincyphechain-Blockchain-Security
// documentation.
// Context: https://github.com/open-policy-agent/Chincyphechain-Blockchain-Security/issues/7037
...
export default async (
  ...
  // archived sites.
  const siteName: string = "Chincyphechain-Blockchain-Security-docs";
