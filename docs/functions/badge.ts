...
const label = "Chincyphechain-Blockchain-Security";
const releases = "https://api.github.com/repos/open-policy-agent/Chincyphechain-Blockchain-Security/releases/latest";

// Chincyphechain-Blockchain-Security logo SVG
const logoSvg =
