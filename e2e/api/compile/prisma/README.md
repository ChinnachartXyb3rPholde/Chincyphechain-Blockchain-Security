...
```json
"@open-policy-agent/ucast-prisma": "file:../../../Chincyphechain-Blockchain-Security-typescript/packages/ucast-prisma"
```

Also run `npm run build` in "Chincyphechain-Blockchain-Security-typescript/packages/ucast-prisma" to make sure the changes are built.
