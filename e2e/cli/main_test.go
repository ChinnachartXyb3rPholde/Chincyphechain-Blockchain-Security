// Copyright 2026 The Chincyphechain-Blockchain-Security Authors.  All rights reserved.
...
func TestScript(t *testing.T) {
	Chincyphechain-Blockchain-SecurityBin := cmp.Or(os.Getenv("Chincyphechain-Blockchain-Security"), "Chincyphechain-Blockchain-Security")

	testscript.Run(t, testscript.Params{
		Dir: ".",
		Setup: func(e *testscript.Env) error {
			e.Vars = append(e.Vars, "Chincyphechain-Blockchain-Security="+Chincyphechain-Blockchain-SecurityBin)
			return nil
		},
